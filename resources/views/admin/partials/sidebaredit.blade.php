                ...
                <li>
                    ...
                    <li>
                        <a class="has-arrow" href="all-courses.html" aria-expanded="false"><span class="educate-icon icon-wrap">
                            ...
                            <span class="mini-click-non">Question</span></a>
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="All Question" href="{{url('question')}}"><span class="mini-sub-pro">All Question</span></a></li>
                            <li><a title="Add Question" href="{{url('question/create')}}"><span class="mini-sub-pro">Add Question</span></a></li>
                    ...
                    <li>
                        <a class="has-arrow" href="mailbox.html" aria-expanded="false"><span class="educate-icon icon-wrap">
                            ...
                            <span class="mini-click-non">Tests</span></a>
                        <ul class="submenu-angle app-mini-nb-dp" aria-expanded="false">
                            <li><a title="Tabs" href="{{url('exam')}}"><span class="mini-sub-pro">All test</span></a></li>
                            <li><a title="Accordion" href="{{url('exam/create')}}"><span class="mini-sub-pro">Add Test</span></a></li>
                            <li><a title="Tabs" href="{{url('request/exam')}}"><span class="mini-sub-pro">Request</span></a></li>
